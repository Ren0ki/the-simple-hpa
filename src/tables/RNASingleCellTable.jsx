import rnaSCData from "../data/RNASingleCellData.json";
...
const RNASingleCellTable = () => {

    const [page, setPage] = useState(1);
    const count = rnaSCData.length;
    const start = (page - 1) * 50;
    const end = start + 50;
    const paginated = rnaSCData.slice(start, end);
...
<div>
   ...
   <table border="1px"> 
        <thead>
            <tr border>
                <th> Gene</th>
                <th> RNA Single Cell Specificity </th>
                <th> Distribution </th>
...
export default RNASingleCellTable;
