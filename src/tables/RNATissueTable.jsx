import rnaTissueData from "../data/RNATissueData.json";
...
const RNATissueTable = () => {

    const [page, setPage] = useState(1);
    const count = rnaTissueData.length;
    const start = (page - 1) * 50;
    const end = start + 50;
    const paginated = rnaTissueData.slice(start, end);
